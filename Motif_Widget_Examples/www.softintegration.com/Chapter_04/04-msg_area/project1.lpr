...
var
  ...
  var
    main_w, menubar, menu, text_w, command_w, message_area: TWidget;
    widget: TWidget = nil;
    app: TXtAppContext;
  ...
  begin
    ...
    label1 := XtVaCreateManagedWidget('label', xmLabelWidgetClass, main_w,
      ...
      XmNlabelPixmap, pixmap, nil);

    message_area := XtVaCreateManagedWidget('This is a test message area', xmLabelWidgetClass, main_w,
      XmNalignment, XmALIGNMENT_BEGINNING, nil);
